...
export class StudentsubscribeComponent implements OnInit {
  ...
  constructor(private dataService: DataService,private authenticationService: AuthenticationService, private subscriptionService: SubscriptionService, private router: Router) {
